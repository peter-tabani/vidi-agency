    ...
    <main className="min-h-screen bg-[#05060b] text-white flex items-center justify-center p-8 font-sans">
      ...
      <div className="relative max-w-lg w-full text-center">
        ...
        <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm shadow-lg mb-6">
          <FileQuestion className="w-8 h-8 text-blue-400" aria-hidden="true" />
        </div>

        {/* Title */}
        <h1 className="text-3xl font-bold mb-4 font-space-grotesk">
          Page Not Found
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/"
            className="inline-flex items-center justify-center gap-2 px-8 py-3 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold hover:shadow-lg hover:shadow-blue-500/30 transition-all focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-[#05060b]"
          >
          ...
          <Link
            href="/case-studies"
            className="inline-flex items-center justify-center gap-2 px-8 py-3 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm text-gray-300 font-semibold hover:bg-white/10 hover:border-white/20 transition-all focus:outline-none focus:ring-2 focus:ring-white/20 focus:ring-offset-2 focus:ring-offset-[#05060b]"
          >
        ...
        <div className="mt-12 pt-8 border-t border-white/10">
          ...
          <div className="flex flex-wrap justify-center gap-4 text-sm font-medium">
            <Link href="/get-started" className="text-blue-400 hover:text-blue-300 transition-colors">
              Get Started
            </Link>
