  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* ============================================================================
          HERO SECTION
          ============================================================================ */}
      <section className="pt-32 pb-20 px-6 md:px-12 lg:px-20 bg-gradient-to-b from-blue-50 via-white to-emerald-50 relative overflow-hidden">
        {/* soft background shapes (no page-local css) */}
        <div className="absolute top-20 right-10 w-96 h-96 bg-blue-200 rounded-full mix-blend-multiply blur-3xl opacity-10" />
        <div className="absolute bottom-20 left-10 w-96 h-96 bg-emerald-200 rounded-full mix-blend-multiply blur-3xl opacity-10" />
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-100 rounded-full mb-6">
              ...
              <span className="text-sm font-bold text-blue-600">
                Welcome to Our Education Division
              </span>
            </div>
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-10 max-w-3xl mx-auto leading-relaxed">
              We partner with forward-thinking educational institutions to create
              custom digital solutions that enhance learning, streamline
              operations, and prepare students for the future.
            </p>

            {/* Role Selector */}
            <div className="mb-12">
              <p className="text-gray-600 mb-4">SELECT ANY PROFESSION BELOW  TO VIEW THE SOLUTIONS:</p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/strategy-call"
                className="px-8 py-4 rounded-full text-base md:text-lg font-bold text-white bg-gradient-to-r from-blue-600 to-emerald-500 hover:shadow-xl transition-all shadow-lg shadow-blue-200 inline-flex items-center justify-center"
              >
              ...
              <Link
                href="#case-studies"
                className="px-8 py-4 rounded-full text-base md:text-lg font-bold text-gray-700 bg-white border-2 border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-all inline-flex items-center justify-center"
              >
      ...
      <section className="py-16 px-6 md:px-12 lg:px-20 bg-white">
        <div className="container mx-auto max-w-6xl">
          <div className="bg-gradient-to-br from-blue-50 to-emerald-50 rounded-3xl p-8 md:p-10 border border-blue-100">
            ...
            {[
              {
                ...
                description:
                  "Custom LMS platforms that match your pedagogy, not force you into a template",
                features: [
                  "Course Management",
                  "Gradebook",
              ...
              },
              {
                ...
                description:
                  "Complete student lifecycle management from enrollment to alumni tracking",
                features: [
                  "Attendance Tracking",
                  "Health Records",
                  "Parent Portals",
              ...
              },
              {
                ...
                description:
                  "AI-powered systems that adjust to each student's learning pace and style",
                features: [
                  "Personalized Paths",
                  "Skill Gaps Analysis",
                  "Progress Tracking",
              ...
              },
              {
                ...
                description:
                  "Engaging hybrid learning environments with interactive tools",
              ...
              },
              {
                ...
                description:
                  "Data-driven insights to improve learning outcomes and operational efficiency",
                features: [
                  "Learning Analytics",
                  "ROI Tracking",
                  "Predictive Analysis",
              ...
              },
              {
                ...
                description:
                  "FERPA/GDPR compliant systems with enterprise-grade security",
                features: [
                  "Data Encryption",
                  "Access Controls",
                  "Audit Logs",
              ...
              return (
                ...
                >
                  <div
                    className={`w-16 h-16 rounded-xl bg-gradient-to-br ${solution.color} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}
                  >
            ...
            {[
              {
                ...
                challenge:
                  "Outdated systems causing 40% admin time on manual processes",
              ...
              },
              {
                ...
                results: [
                  ...
                  "Reduced IT tickets by 70%",
                  "Scaled to 15,000+ users",
                ],
                type: "University",
              },
            ].map((caseStudy, idx) => (
              <div
                key={idx}
                className="bg-gradient-to-br from-blue-50 to-white rounded-2xl p-8 border border-blue-100 hover:shadow-xl transition-all"
              >
      ...
      <section className="py-20 px-6 md:px-12 lg:px-20 bg-gradient-to-br from-blue-50 to-emerald-50">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="relative">
            <div className="hidden lg:block absolute left-1/2 -translate-x-1/2 top-1/2 h-1 w-3/4 bg-gradient-to-r from-blue-300 to-emerald-300" />
              ...
              {[
                {
                  ...
                  description:
                    "We meet with stakeholders to understand your unique needs and challenges",
                  duration: "1-2 weeks",
                  icon: MessageSquare,
                },
                {
                  ...
                  description:
                    "Our learning experience designers create pedagogically sound solutions",
                  duration: "2-3 weeks",
                  icon: Brain,
                },
                {
                  ...
                  description:
                    "Agile development with continuous feedback and staff training",
                  duration: "4-12 weeks",
                  icon: Zap,
                },
                {
                  ...
                  description:
                    "Phased rollout with ongoing support and improvement cycles",
                  duration: "Ongoing",
                  icon: Award,
                },
              ].map((step, idx) => {
      ...
      <section className="py-20 px-6 md:px-12 lg:px-20 bg-gradient-to-r from-blue-600 to-emerald-600">
        <div className="container mx-auto max-w-4xl text-center text-white">
          ...
          <p className="mt-8 text-blue-100">
            ⏰ Average session length: 45 minutes • 📍 Virtual or On-site • 🎯 No
            sales pitch
          </p>
        </div>
      </section>
